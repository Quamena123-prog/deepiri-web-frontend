...
function loadD3Inline() {
  const candidates = [
    join(ROOT, 'node_modules', 'd3', 'dist', 'd3.min.js'),
    join(ROOT, 'node_modules', 'd3', 'dist', 'd3.js'),
  ];
  for (const c of candidates) {
    try {
      let src = readFileSync(c, 'utf-8');
  ...
  return '/* d3.min.js not found locally; using CDN */ document.write("<scr"+"ipt src=\\"https://d3js.org/d3.v7.min.js\\"></scr"+"ipt>");';
}
